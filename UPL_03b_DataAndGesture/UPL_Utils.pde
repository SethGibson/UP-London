...
void setupHashMaps()
{
  ...
  dayColors.put("Monday", (Integer)color(0,64,255));  
  dayColors.put("Tuesday", (Integer)color(0,128,255));
  dayColors.put("Wednesday", (Integer)color(0,148,255));
  dayColors.put("Thursday", (Integer)color(0,160,255));
  dayColors.put("Friday", (Integer)color(0,192,255));
}
